...
// Ze German Biers
	...
	else if(beer.indexOf("German" && "Zwickelbier") !==-1) {
		return
	}
...
// the Scottish Dark Style

	else if(beer.indexOf("Scottish-Style Light Ale") !==-1) {
		return
	}

	else if(beer.indexOf("Scottish-Style Heavy Ale") !==-1) {
		return
	}

	else if(beer.indexOf("Scottish-Style Export Ale") !==-1){
		return
	}
...
// the Cider
	...
	else if(beer.indexOf("English Cider") !==-1){
		return
	}
	...
	else if(beer.indexOf("Specialty Cider") !==-1){
		return
	}
...
// The General Stuff - Outcast Beers that don't fit in
	...
	else if(beer.indexOf("Scotch Ale") !==-1){
		return
	}

	else if(beer.indexOf("Cream Stout") !==1){
		return
	}
	...
	else if(beer.indexOf("Double IPA") !==-1){
		return
	}

	else if(beer.indexOf("Blonde IPA") !==-1){
		return
	}

	else if(beer.indexOf("Session India Pale Ale") !==-1){
		return
	}

	else if(beer.indexOf("Session Beer") !==-1){
		return
	}

	else if(beer.indexOf("Wood Barrel-Aged") !==-1){
		return
	}

	else if(beer.indexOf("Wood Barrel-Aged Pale Beer") !==-1){
		return
	}

	else if(beer.indexOf("Wood Barrel-Aged Dark Beer") !==-1){
		return
	}

	else if(beer.indexOf("Wild Beer") !==-1){
		return
	}

	else if(beer.indexOf("Gluten-Free Beer") !==-1){
		return
	}

	else if(beer.indexOf("Pumpkin") !==-1){
		return
	}

	else if(beer.indexOf("Coffee-Flavored") !==-1){
		return
	}

	else if(beer.indexOf("Chocolate") !==-1){
		return
	}

	else if(beer.indexOf("Fruit") !==-1){
		return
	}
